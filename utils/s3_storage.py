...
class S3Storage:
    ...
    def _validate_image_file(self, file_obj: Union[InMemoryUploadedFile, TemporaryUploadedFile, BytesIO], 
    ...
    def _validate_encoding_metadata(self, encoding: str, quality: float, 
                                  original_size: int, encoded_size: int,
        ...
        if encoding not in allowed_encodings:
            raise S3StorageError(
                f"Invalid encoding '{encoding}'. Allowed: {', '.join(allowed_encodings)}"
            )
    ...
    def download_file(self, key: str, download_path: Optional[str] = None) -> Union[bytes, bool]:
        ...
        try:
            ...
            if error_code == 'NoSuchKey':
                raise S3StorageError(f"File not found in S3: {key}")
            else:
    ...
    def file_exists(self, key: str) -> bool:
        ...
        try:
            ...
            if e.response['Error']['Code'] == '404':
                return False
            raise S3StorageError(f"Error checking file existence: {str(e)}")
    ...
    def get_file_info(self, key: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if error_code == '404':
                ...
                raise S3StorageError(f"Error getting file info: {str(e)}")
    ...
    def get_file_url(self, key: str, public: bool = False, expires_in: int = 3600) -> str:
        ...
        if public:
            ...
            try:
                ...
                raise S3StorageError(f"Error generating presigned URL: {str(e)}")
    ...
    def generate_presigned_upload_url(
        ...
        try:
            ...
            raise S3StorageError(f"Error generating presigned upload URL: {str(e)}")
    ...
    def upload_user_avatar(
        self,
        user_id: str,
        avatar_file: Union[InMemoryUploadedFile, TemporaryUploadedFile]
    ) -> Dict[str, Any]:
        """
    ...
    def update_profile_picture(
        ...
        Returns:
            Upload result
        """
        return self.upload_profile_picture(
            user_id=user_id,
