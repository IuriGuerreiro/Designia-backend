...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    async def connect(self):
        ...
        await self.channel_layer.group_send(
            ...
            {"type": "user_joined", "user_id": self.user.id, "username": self.user.username, "chat_id": self.chat_id},
        )
    ...
    async def handle_chat_message(self, data):
        ...
        await self.channel_layer.group_send(
            self.room_group_name, {"type": "chat_message", "message": message_data, "chat_id": self.chat_id}
        )
    ...
    async def handle_typing_start(self):
        ...
        await self.channel_layer.group_send(
            self.room_group_name,
            {"type": "typing_start", "user_id": self.user.id, "username": self.user.username, "chat_id": self.chat_id},
        )
    ...
    async def handle_typing_stop(self):
        ...
        await self.channel_layer.group_send(
            self.room_group_name,
            {"type": "typing_stop", "user_id": self.user.id, "username": self.user.username, "chat_id": self.chat_id},
        )
    ...
    async def handle_mark_read(self):
        ...
        await self.channel_layer.group_send(
            self.room_group_name, {"type": "messages_read", "user_id": self.user.id, "chat_id": self.chat_id}
        )
    ...
    async def chat_message(self, event):
        ...
        await self.send(text_data=json.dumps({"type": "chat_message", "message": message, "chat_id": chat_id}))
    ...
    def save_message(self, message_type, text_content=None, image_url=None):
        ...
        try:
            ...
            message = Message.objects.create(
                chat=chat, sender=self.user, message_type=message_type, text_content=text_content, image_url=image_url
            )
