...
class SellerApplicationImageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'image', 'image_type', 'description',
            'order', 'uploaded_at'
        ]
...
class SellerApplicationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'user', 'business_name', 'seller_type', 'motivation',
            'portfolio_url', 'social_media_url', 'status',
            'admin_notes', 'rejection_reason', 'submitted_at',
            'reviewed_at', 'approved_by', 'rejected_by',
            'approved_by_name', 'rejected_by_name',
            'user_email', 'user_name', 'images',
            'uploaded_images', 'image_descriptions', 'image_types'
        ]
        read_only_fields = [
            'id', 'status', 'admin_notes', 'rejection_reason',
            'submitted_at', 'reviewed_at', 'approved_by', 'rejected_by'
        ]
