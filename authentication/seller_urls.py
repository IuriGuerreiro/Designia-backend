...
urlpatterns = [
    ...
    # Admin endpoints
    path('admin/seller/applications/', seller_views.SellerApplicationListView.as_view(), name='admin_seller_applications'),
    path('admin/seller/applications/<int:pk>/', seller_views.SellerApplicationAdminUpdateView.as_view(), name='admin_seller_application_update'),
