...
try:
    ...
    logger.warning("Warning: Google auth libraries not available. Install with: pip install google-auth google-auth-oauthlib")
...
class GoogleAuth:
    ...
    def verify_google_token(token):
        ...
        try:
            ...
            logger.info(f"🔍 Verifying token with client_id...")
            # Verify the token
    ...
    def get_or_create_user(google_user_info):
        ...
        """
        logger = logging.getLogger(__name__)
        logger.info(f"🔍 Getting/creating user from Google info...")
        ...
        try:
            ...
            logger.info(f"🔍 User doesn't exist, creating new user...")
