...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        seller = User.objects.filter(role="seller", stripe_account_id__isnull=False).first()
        ...
        category, _ = Category.objects.get_or_create(
            name="Test Category", defaults={"description": "Test category for payment testing"}
        )
        ...
        self.stdout.write("\n👥 Test Users:")
        self.stdout.write("   Seller: testseller@test.com / testpass123")
        self.stdout.write("   Buyer:  testbuyer@test.com / testpass123")
        self.stdout.write("   Admin:  testadmin@test.com / testpass123")
