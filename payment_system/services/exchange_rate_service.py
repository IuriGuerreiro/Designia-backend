    ...
    def _get_test_data(cls, base_currency: str) -> Dict:
        ...
        test_rates = {
            'USD': {
                ...
                'PLN': 3.9, 'CZK': 21.5, 'HUF': 295.0, 'RUB': 75.0, 'BRL': 5.2,
                'INR': 74.0, 'KRW': 1180.0, 'SGD': 1.35, 'HKD': 7.8, 'MXN': 20.1,
                'TRY': 8.5, 'ZAR': 14.5, 'THB': 31.5, 'MYR': 4.1, 'PHP': 49.5,
                'IDR': 14250.0, 'VND': 22800.0, 'ILS': 3.2, 'CLP': 800.0, 'TWD': 28.0
            },
            'EUR': {
                'USD': 1.18, 'GBP': 0.86, 'JPY': 129.0, 'CAD': 1.47, 'AUD': 1.59,
                'CHF': 1.08, 'CNY': 7.6, 'SEK': 10.0, 'NOK': 10.4, 'DKK': 7.4,
                'PLN': 4.6, 'CZK': 25.3, 'HUF': 347.0, 'RUB': 88.0
            },
            'GBP': {
                'USD': 1.37, 'EUR': 1.16, 'JPY': 150.0, 'CAD': 1.71, 'AUD': 1.85,
                'CHF': 1.26, 'CNY': 8.8, 'SEK': 11.6, 'NOK': 12.1, 'DKK': 8.6
            }
        }
