"""
Legacy Scheduler Service - DEPRECATED
...
# Deprecation warning
warnings.warn(
    "SchedulerService is deprecated. Use CelerySchedulerService instead.",
    DeprecationWarning,
    stacklevel=2
)
...
def get_apscheduler_installation_guide() -> str:
    ...
    """
    return CelerySchedulerService.get_celery_installation_guide() if hasattr(CelerySchedulerService, 'get_celery_installation_guide') else """
