...
class PayoutSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Payout
        fields = [
            'id', 'stripe_payout_id', 'seller_username', 'status', 'payout_type',
            'amount_decimal', 'formatted_amount', 'currency', 'transfer_count',
            'total_gross_amount', 'total_fees', 'bank_account_last4', 'bank_name',
            'arrival_date', 'failure_code', 'failure_message', 'description',
            'is_completed', 'is_failed', 'days_since_created', 'created_at', 
            'updated_at', 'payout_items'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']
...
class PayoutSummarySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'stripe_payout_id', 'seller_username', 'status', 'payout_type',
            'amount_decimal', 'formatted_amount', 'currency', 'transfer_count',
            'bank_account_last4', 'bank_name', 'arrival_date', 'is_completed',
            'is_failed', 'days_since_created', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']