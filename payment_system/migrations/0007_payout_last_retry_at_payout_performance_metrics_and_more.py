...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.JSONField(blank=True, default=dict, help_text='Performance metrics: API response times, database query times, etc.'),
        ),
        migrations.AddField(
            model_name='payout',
        ...
        migrations.AddField(
            ...
            field=models.CharField(choices=[('pending', 'Pending Reconciliation'), ('matched', 'Successfully Matched'), ('mismatched', 'Mismatched'), ('manual_review', 'Requires Manual Review')], default='pending', help_text='Reconciliation status against bank records', max_length=20),
        ),
        migrations.AddField(
            model_name='payout',
            name='retry_count',
        ...
        migrations.AddField(
            model_name='payout',
            name='status_history',
            field=models.JSONField(blank=True, default=list, help_text='Audit trail of status changes with timestamps and reasons'),
        ),
        migrations.AddIndex(
            model_name='payout',
