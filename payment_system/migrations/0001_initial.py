    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transfer_id', models.CharField(blank=True, db_index=True, help_text='Stripe transfer ID when payment is transferred to seller', max_length=255, null=True)),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('held', 'On Hold'), ('processing', 'Processing'), ('completed', 'Completed'), ('released', 'Released to Seller'), ('disputed', 'Disputed'), ('refunded', 'Refunded'), ('failed', 'Failed')], default='pending', max_length=20)),
                ...
                ('hold_reason', models.CharField(choices=[('standard', 'Standard Hold Period'), ('new_seller', 'New Seller Verification'), ('high_value', 'High Value Transaction'), ('suspicious', 'Suspicious Activity'), ('dispute', 'Dispute Filed'), ('manual', 'Manual Hold')], default='standard', max_length=20)),
                ...
                ('planned_release_date', models.DateTimeField(blank=True, help_text='Calculated release date', null=True)),
                ('actual_release_date', models.DateTimeField(blank=True, help_text='When payment was actually released', null=True)),
                ...
                ('released_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='released_payment_transactions', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('seller', models.ForeignKey(help_text='Seller receiving the payout', on_delete=django.db.models.deletion.CASCADE, related_name='payouts', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['base_currency', 'target_currency', '-created_at'], name='payment_exc_base_cu_a24be2_idx'), models.Index(fields=['created_at'], name='payment_exc_created_d77919_idx'), models.Index(fields=['is_active'], name='payment_exc_is_acti_3c76c1_idx')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('payment_transfer', models.ForeignKey(help_text='The payment transfer included in the payout', on_delete=django.db.models.deletion.CASCADE, related_name='payout_items', to='payment_system.paymenttransaction')),
                ('payout', models.ForeignKey(help_text='The payout this item belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='payout_items', to='payment_system.payout')),
            ],
            options={
                'db_table': 'payment_payout_items',
                'ordering': ['-transfer_date'],
                'indexes': [models.Index(fields=['payout', '-transfer_date'], name='payment_pay_payout__ac0ced_idx'), models.Index(fields=['payment_transfer'], name='payment_pay_payment_9946f7_idx'), models.Index(fields=['order_id'], name='payment_pay_order_i_4b775b_idx')],
