...
def create_connected_account(iban: str, config: Dict) -> Optional[Dict]:
    ...
    try:
        ...
        log_message("INFO", f"   Attaching external bank account...")
        ...
        log_message("INFO", f"   Account status - Charges: {full_account.charges_enabled}, Payouts: {full_account.payouts_enabled}")
...
def main():
    ...
    if failed > 0:
        ...
        print(f"   You can re-run this script to try again.")
