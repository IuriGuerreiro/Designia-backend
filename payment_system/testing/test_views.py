...
class PaymentProcessingViewTestCase(PaymentAPITestCase):
    ...
    def test_successful_payment_processing(self, mock_payment_intent):
        ...
        mock_payment_intent.return_value = MagicMock(
            id="pi_test123", status="succeeded", client_secret="pi_test123_secret"
        )
        ...
        response = self.client.post(
            ...
            {"order_id": str(self.order.id), "payment_method_id": "pm_test123"},
            format="json",
        )
    ...
    def test_payment_processing_invalid_order(self):
        ...
        response = self.client.post(
            "/api/payments/process/",
            {"order_id": "00000000-0000-0000-0000-000000000000", "payment_method_id": "pm_test123"},
            format="json",
        )
...
class StripeAccountViewTestCase(PaymentAPITestCase):
    ...
    def test_create_stripe_account(self, mock_account_link, mock_account):
        ...
        mock_account_link.return_value = MagicMock(url="https://connect.stripe.com/setup/acct_new123")

        # Create user without existing Stripe account
        new_seller = User.objects.create_user(username="newseller", email="newseller@test.com")
        ...
        response = self.client.post("/api/payments/stripe-account/create/", {"country": "US"}, format="json")
    ...
    def test_get_stripe_account_status_not_found(self):
        ...
        new_user = User.objects.create_user(username="newuser", email="newuser@test.com")
...
class PaymentStatusViewTestCase(PaymentAPITestCase):
    ...
    def test_get_payment_status_unauthorized(self):
        ...
        other_buyer = User.objects.create_user(username="otherbuyer", email="other@test.com")
...
class SellerPayoutViewTestCase(PaymentAPITestCase):
    ...
    def test_get_seller_payouts(self):
        ...
        _payout = SellerPayout.objects.create(
            payment=payment,
            seller=self.seller,
...
class WebhookViewTestCase(PaymentAPITestCase):
    ...
    def test_webhook_payment_succeeded(self, mock_construct_event):
        ...
        self.assertTrue(WebhookEvent.objects.filter(stripe_event_id="evt_test123").exists())
