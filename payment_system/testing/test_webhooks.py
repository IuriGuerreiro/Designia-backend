...
from payment_system.models import (
    StripeAccount, Payment, SellerPayout, WebhookEvent
)
...
class StripeWebhookTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.buyer = User.objects.create_user(
            username='webhook_buyer',
            email='buyer@webhooktest.com'
        )
        self.seller = User.objects.create_user(
            username='webhook_seller',
            email='seller@webhooktest.com'
        )
    ...
    def test_payment_intent_succeeded_webhook(self, mock_construct_event):
        ...
        webhook_payload = self.create_stripe_webhook_payload(
        ...
        webhook_event = WebhookEvent.objects.get(
            stripe_event_id=webhook_payload['id']
        )
        ...
        try:
            response = requests.post(
                ...
                headers={
                    ...
                    'Stripe-Signature': 'test_signature_from_cli'
                },
                timeout=30
            )
            return response
