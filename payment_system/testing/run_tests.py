...
class PaymentSystemTestRunner:
    ...
    def check_coverage_available(self):
        """Check if coverage.py is available without importing it"""
        try:
    ...
    def install_test_dependencies(self):
        ...
        dependencies = ["coverage", "pytest", "pytest-django", "pytest-cov", "factory-boy"]  # For test data generation
    ...
    def run_with_coverage(self, verbosity=2):
        ...
        try:
            ...
            cov = coverage.Coverage(
                ...
                omit=["*/tests/*", "*/testing/*", "*/migrations/*", "*/venv/*", "*/site-packages/*"],
            )
    ...
    def run_performance_tests(self):
        ...
        try:
            ...
            users = []
            for i in range(100):
                user = User.objects.create_user(username=f"perf_user_{i}", email=f"perf{i}@test.com")
                users.append(user)
