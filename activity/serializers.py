...
class UserClickSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserClick
        fields = [
            'id', 'product', 'product_name', 'action', 'user', 'user_email', 
...
class ActivitySummarySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'product', 'product_name', 'period_type', 'period_start', 'period_end',
            'total_views', 'total_clicks', 'total_favorites', 'total_unfavorites',
            'total_cart_additions', 'total_cart_removals', 'unique_users', 'unique_sessions',
            'view_to_click_rate', 'click_to_cart_rate', 'favorite_to_unfavorite_ratio',
