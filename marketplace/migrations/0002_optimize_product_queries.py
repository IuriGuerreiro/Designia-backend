...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="product",
            index=models.Index(
                fields=["is_active", "-favorite_count"], name="marketplace_product_active_favorites_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="product",
            index=models.Index(
                fields=["category", "is_active", "-created_at"], name="marketplace_product_category_active_created_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="product",
            index=models.Index(
                fields=["seller", "is_active", "-created_at"], name="marketplace_product_seller_active_created_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="product",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["product", "-is_primary", "order", "created_at"],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["product", "is_active", "rating"], name="marketplace_productreview_product_active_idx"
            ),
        ),
    ]
