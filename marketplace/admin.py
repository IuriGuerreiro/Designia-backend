...
class ProductAdmin(admin.ModelAdmin):
    ...
    list_filter = ("is_active", "is_featured", "is_digital", "condition", "category", "seller", "created_at")
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("id", "name", "slug", "description", "short_description")}),
        ...
        ("Status & Visibility", {"fields": ("is_active", "is_featured", "is_digital")}),
        (
            "Metrics",
            {
...
class ProductReviewAdmin(admin.ModelAdmin):
    list_display = ("product", "reviewer", "rating", "title", "is_verified_purchase", "is_active", "created_at")
    ...
    fieldsets = (
        (None, {"fields": ("product", "reviewer", "rating", "title", "comment")}),
        ("Status", {"fields": ("is_verified_purchase", "is_active")}),
        ("Timestamps", {"fields": ("created_at", "updated_at"), "classes": ("collapse",)}),
    )
...
class OrderAdmin(admin.ModelAdmin):
    list_display = ("id", "buyer", "status", "payment_status", "total_amount", "created_at", "item_count")
    ...
    fieldsets = (
        ("Order Information", {"fields": ("id", "buyer", "status", "payment_status")}),
        ("Pricing", {"fields": ("subtotal", "shipping_cost", "tax_amount", "discount_amount", "total_amount")}),
        (
            "Shipping",
            {"fields": ("shipping_address", "tracking_number", "shipping_carrier", "shipped_at", "delivered_at")},
        ),
        ("Notes", {"fields": ("buyer_notes", "admin_notes"), "classes": ("collapse",)}),
        ("Timestamps", {"fields": ("created_at", "updated_at"), "classes": ("collapse",)}),
    )
