...
class Command(BaseCommand):
    ...
    def create_categories(self):
        ...
        categories_data = [
            ...
            {"name": "Tables", "description": "Dining tables, coffee tables, and more", "slug": "tables"},
            {"name": "Chairs", "description": "Dining chairs, office chairs, accent chairs", "slug": "chairs"},
            {"name": "Beds & Mattresses", "description": "Comfortable sleeping solutions", "slug": "beds-mattresses"},
            {
                "name": "Storage & Organization",
                "description": "Wardrobes, shelves, and storage solutions",
                "slug": "storage-organization",
            },
            {"name": "Lighting", "description": "Lamps, chandeliers, and light fixtures", "slug": "lighting"},
            {
    ...
    def create_sample_users(self, count):
        ...
        users = []
        for _i, user_data in enumerate(sample_users[:count]):
    ...
    def create_product_image(self, product, image_url):
        ...
        try:
            ...
            with open(temp_file_path, "rb") as image_file:
                ...
                product_image = ProductImage.objects.create(product=product, is_primary=True, order=0)
