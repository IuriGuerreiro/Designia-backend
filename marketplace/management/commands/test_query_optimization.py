...
class Command(BaseCommand):
    ...
    def test_query_optimization(self, product_count, show_queries):
        ...
        self.stdout.write(f"   - Used prefetch_related for images, reviews, favorites")
        self.stdout.write(f"   - Added select_related for seller and category")
        self.stdout.write(f"   - Pre-calculated review counts and ratings with annotations")
        self.stdout.write(f"   - Optimized primary image lookup with prefetched data")
        self.stdout.write(f"   - Added comprehensive database indexes")
